...
urlpatterns = [
    ...
    path('workload_teacher/<int:pk>/', workload_teacher_detail, name='workload_teacher_detail'),
    path('workload_teacher/create/', workload_teacher_create, name='workload_teacher_create'),
    path('workload_teacher/<int:pk>/edit/', workload_teacher_update, name='workload_teacher_update'),
